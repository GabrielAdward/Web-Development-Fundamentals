...
router.post("/create", function (request, response) {
  ...
  if (posttitle == "") {
    ...
    errorMessages.push(
      "Title may be at most " + POST_TITLE_MAX_LENGTH + " characters long"
    );
  }
  ...
  if (postmessage == "") {
    ...
    errorMessages.push(
      "Message may be at most " + POST_MESSAGE_MAX_LENGTH + " characters long"
    );
  }
...
router.post("/add-comments/:id/:page", function (request, response) {
  ...
  if (newComment == "") {
    ...
    errorMessages.push(
      "Title may be at most " + POST_COMMENT_MAX_LENGTH + " characters long"
    );
  }
